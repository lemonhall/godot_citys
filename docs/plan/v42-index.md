...
| M3 active flight foundation | 第三人称自稳定 hover flight | `W/A/S/D` 平面移动、`E/Space` 上升、`Q` 下降、松手 hover 与平滑姿态成立；机体默认 stable heading，不按平面速度自动扭 yaw；前冲速度/前倾姿态与 enlarged third-person presentation 达到正式飞行器观感 | `tests/world/test_city_player_drone_flight_input_contract.gd`、`tests/world/test_city_player_drone_speed_and_attitude_contract.gd`、`tests/world/test_city_player_drone_presentation_contract.gd` | done |
