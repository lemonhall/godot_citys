...
当前状态：`M0-M4` 已在 [v39-m4-verification-2026-03-23.md](./v39-m4-verification-2026-03-23.md) 中完成 fresh functional verification；`M5 spider realism pass` 已在 [v39-m5-verification-2026-03-23.md](./v39-m5-verification-2026-03-23.md) 中完成 fresh verification；`M6 spider reference stepper alignment` 已在 [v39-m6-verification-2026-03-23.md](./v39-m6-verification-2026-03-23.md) 中完成 fresh verification；`M7 spider reference scheduler alignment` 已在 [v39-m7-verification-2026-03-23.md](./v39-m7-verification-2026-03-23.md) 中完成 fresh verification；`M8 spider reference internals alignment` 已在 [v39-m8-verification-2026-03-23.md](./v39-m8-verification-2026-03-23.md) 中完成 fresh verification。当前 spider 正式入口已经收口为单一 `SpiderCrawlerLab.tscn`；spider gait 也进一步从“像参考项目”推进到“内部原理分块对齐”，现在明确覆盖 `stillness-gated step desire + timer-based tetrapod scheduler + prediction/default structured surface search + leg-centroid/plane-normal body solver + reference-style body visual smoothing`，并新增 chase 态 lateral jitter contract 防止躯干再次出现 1-2 帧左右抽动，但仍不宣称已经接入主世界。
...
| M5 spider realism pass | spider proxy silhouette、leg ratio、swing arc、single lab entry | spider 不再只是“会走”，而是至少具备可读的蜘蛛 silhouette，并在单一 `SpiderCrawlerLab` 里稳定展示 | `tests/world/test_spider_crawler_leg_visual_contract.gd`、`tests/world/test_spider_crawler_lab_scene_contract.gd`、`tests/world/test_spider_crawler_lab_demo_contract.gd`、`tests/world/test_spider_crawler_gait_contract.gd`、`tests/world/test_spider_crawler_terrain_follow_contract.gd`、`tests/e2e/test_spider_crawler_lab_flow.gd`、[v39-m5-verification-2026-03-23.md](./v39-m5-verification-2026-03-23.md) | done |
| M6 spider reference stepper | reference-driven spider step manager、anchor prediction、arc stepping | spider gait 不再只是 phase-clock，而是明确对齐一个完整参考实现的 stepping 管线 | `tests/world/test_spider_crawler_reference_step_contract.gd`、`tests/world/test_spider_crawler_leg_visual_contract.gd`、`tests/world/test_spider_crawler_lab_scene_contract.gd`、`tests/world/test_spider_crawler_lab_demo_contract.gd`、`tests/world/test_spider_crawler_gait_contract.gd`、`tests/world/test_spider_crawler_terrain_follow_contract.gd`、`tests/e2e/test_spider_crawler_lab_flow.gd`、[v39-m6-verification-2026-03-23.md](./v39-m6-verification-2026-03-23.md) | done |
| M7 spider reference scheduler | explicit timer-based tetrapod scheduler、group average step time、scheduler debug contract | spider gait scheduler 不再只是 phase window，而是明确对齐 `IKStepManager.AlternatingTetrapodGait()` 的 timer/switch cadence | `tests/world/test_spider_crawler_reference_scheduler_contract.gd`、`tests/world/test_spider_crawler_reference_step_contract.gd`、`tests/world/test_spider_crawler_body_target_stability_contract.gd`、`tests/world/test_spider_crawler_leg_visual_contract.gd`、`tests/world/test_spider_crawler_lab_scene_contract.gd`、`tests/world/test_spider_crawler_lab_demo_contract.gd`、`tests/world/test_spider_crawler_gait_contract.gd`、`tests/world/test_spider_crawler_terrain_follow_contract.gd`、`tests/e2e/test_spider_crawler_lab_flow.gd`、[v39-m7-verification-2026-03-23.md](./v39-m7-verification-2026-03-23.md) | done |
| M8 spider reference internals | stillness gate、structured surface search、leg centroid/plane normal body solver、body visual smoothing | spider 不仅 scheduler 对齐参考实现，`IKStepper.stepCheck()`、`findTargetOnSurface()`、`Spider.getLegsCentroid()/GetLegsPlaneNormal()`、`Spider.Update()` 里的 body smoothing 也开始逐块对齐 | `tests/world/test_spider_crawler_reference_step_desire_contract.gd`、`tests/world/test_spider_crawler_reference_surface_search_contract.gd`、`tests/world/test_spider_crawler_reference_body_solver_contract.gd`、`tests/world/test_spider_crawler_reference_scheduler_contract.gd`、`tests/world/test_spider_crawler_reference_step_contract.gd`、`tests/world/test_spider_crawler_body_target_stability_contract.gd`、`tests/world/test_spider_crawler_lab_body_lateral_jitter_contract.gd`、`tests/world/test_spider_crawler_leg_visual_contract.gd`、`tests/world/test_spider_crawler_lab_scene_contract.gd`、`tests/world/test_spider_crawler_lab_demo_contract.gd`、`tests/world/test_spider_crawler_gait_contract.gd`、`tests/world/test_spider_crawler_terrain_follow_contract.gd`、`tests/e2e/test_spider_crawler_lab_flow.gd`、[v39-m8-verification-2026-03-23.md](./v39-m8-verification-2026-03-23.md) | done |
