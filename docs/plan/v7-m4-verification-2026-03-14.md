...
- 本留档不声明“所有下游系统都已完整消费交叉口语义”。当前正式 runtime consumer 主要仍是 `pedestrian_crossing_candidate` 这一级 gating；更丰富的 `ordered_branches / branch_connection_semantics` consumerization 仍留给后续交通标识系统 / 车辆系统 / 更丰富的行人系统版本。
