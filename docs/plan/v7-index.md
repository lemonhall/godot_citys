...
- 当前 `v7` 处于 `M1-M2 done / M3-M4 todo` 的执行态；不得把当前状态描述为“`v7` 整体已完成”。当前已完成的是 edge + intersection 两段 shared semantic contract；consumer 深接管和 runtime node guard 仍未收口。
