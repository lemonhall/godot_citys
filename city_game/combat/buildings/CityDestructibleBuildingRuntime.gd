...
func get_debug_state() -> Dictionary:
	...
	return {
		...
		"dynamic_chunk_sleeping_count": int(collapse_state.get("dynamic_chunk_sleeping_count", 0)),
		"dynamic_chunk_mesh_instance_count": int(collapse_state.get("dynamic_chunk_mesh_instance_count", 0)),
		"dynamic_chunk_collision_shape_count": int(collapse_state.get("dynamic_chunk_collision_shape_count", 0)),
		"dynamic_chunk_shadow_caster_count": int(collapse_state.get("dynamic_chunk_shadow_caster_count", 0)),
		"dynamic_chunk_total_linear_speed_mps": float(collapse_state.get("dynamic_chunk_total_linear_speed_mps", 0.0)),
		"dynamic_chunk_peak_linear_speed_mps": float(collapse_state.get("dynamic_chunk_peak_linear_speed_mps", 0.0)),
		"dynamic_chunk_sleeping_ratio": float(collapse_state.get("dynamic_chunk_sleeping_ratio", 0.0)),
		"dynamic_chunk_airborne_count": int(collapse_state.get("dynamic_chunk_airborne_count", 0)),
		"dynamic_chunk_sleeping_airborne_count": int(collapse_state.get("dynamic_chunk_sleeping_airborne_count", 0)),
		"residual_base_visible": bool(collapse_state.get("residual_base_visible", false)),
		"debris_sleep_delay_sec": float(collapse_state.get("debris_sleep_delay_sec", 0.0)),
		...
		"explosion_impulse_enabled": bool(collapse_state.get("explosion_impulse_enabled", false)),
		"impact_zone_average_launch_speed_mps": float(collapse_state.get("impact_zone_average_launch_speed_mps", 0.0)),
		"far_zone_average_launch_speed_mps": float(collapse_state.get("far_zone_average_launch_speed_mps", 0.0)),
		"impact_zone_average_blast_alignment": float(collapse_state.get("impact_zone_average_blast_alignment", 0.0)),
