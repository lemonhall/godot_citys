...
|---|---|---|---|---|
| M1 世界数据骨架 | 确定性世界配置、district/road/block/parcel 数据模型 | 固定 seed 下 `7000m x 7000m` 世界与 `256m x 256m` chunk 配置稳定生成；禁止整城节点树常驻 | `test_city_world_model.gd`、`test_city_world_generator.gd` | todo |
...
|---|---|---|---|---|---|
| REQ-0001-001 | `v2-world-data-model.md` | `tests/world/test_city_world_model.gd` | `--script res://tests/world/test_city_world_model.gd` | — | todo |
| REQ-0001-002 | `v2-world-data-model.md` | `tests/world/test_city_world_generator.gd` | `--script res://tests/world/test_city_world_generator.gd` | — | todo |
...
- v1 只有小规模程序化街区，尚无 district / chunk / parcel 数据层。
